  ...
  return (
    <section className="editor">
      <div className="editor-toolbar">
        <div>
          <h2 className="editor-title">{activeDashboard} · {selectedDay.dayLabel} Tasks</h2>
          <p className="editor-sub">{selectedDay.dateLabel} checklist for the {activeDashboard} dashboard</p>
        </div>
